...
- Specify exact file locations, affected modules, interface changes, and test scenarios.
- Keep prose caveman-compressed: technical terms exact, direct steps, zero fluff.
